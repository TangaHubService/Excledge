...
function invoiceInfoRow(iconName, label, value) {
    if (!isPresent(value))
        return "";
    return `
    <div class="info-row">
...
function renderSalesInvoiceHtml(data) {
