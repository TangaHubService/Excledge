...
class EmailService {
        ...
        <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; max-width: 600px; margin: 0 auto; color: #333; line-height: 1.6;">
          ...
          <div style="padding: 30px; background-color: #ffffff; border: 1px solid #e5e7eb; border-top: none; border-radius: 0 0 8px 8px;">
            ...
            <div style="text-align: center; margin-top: 40px; border-top: 1px solid #f3f4f6; padding-top: 20px;">
                <a href="${config.primaryFrontendUrl}/dashboard" style="background-color: #1e40af; color: white; padding: 12px 25px; text-decoration: none; border-radius: 6px; font-weight: bold; display: inline-block;">View Full Dashboard</a>
  ...
  async sendPasswordResetEmail(email: string, name: string, token: string) {
    const resetLink = `${config.primaryFrontendUrl}/reset-password?token=${token}&email=${encodeURIComponent(email)}`;
    ...
    await this.sendMail({
      ...
      text: [
        `Hello ${name},`,
        '',
        `Your ${config.appName} password reset code is: ${token}`,
        '',
        ...
        <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; max-width: 600px; margin: 0 auto; color: #333; line-height: 1.6;">
          ...
          <div style="padding: 40px; background-color: #ffffff; border: 1px solid #e5e7eb; border-top: none; border-radius: 0 0 8px 8px; text-align: center;">
            ...
            <div style="margin-top: 20px;">
              <a href="${config.primaryFrontendUrl}/dashboard/settings/subscription" 
