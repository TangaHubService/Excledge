...
export function PaymentMethodsReportPage() {
  ...
  const q = useReportQuery<any>(["report-payment-methods", params], "/reports/payment-methods", params);
  return (
    <section className="page-stack">
      ...
      {q.isLoading ? <Skeleton height={180} /> : (
        <>
          <div className="panel">
            <DataTable rows={q.data?.data ?? []} columns={[{ key: "paymentMethod", title: "Payment Method" }, { key: "totalTransactions", title: "Total Transactions" }, { key: "totalAmount", title: "Total Amount (RWF)" }]} />
          </div>
