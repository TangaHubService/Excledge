...
export function InventoryValueReportPage() {
  ...
  const q = useReportQuery<any>(["report-inventory-value", params], "/reports/inventory-value", params);

  return (
    <section className="page-stack">
      <h1>Inventory Value Summary</h1>
      <FilterBar
        filters={filters}
      ...
      {q.isLoading ? <Skeleton height={180} /> : (
        <>
          <div className="panel">
            <DataTable rows={q.data?.data ?? []} columns={[{ key: "productName", title: "Product Name" }, { key: "category", title: "Category" }, { key: "quantity", title: "Quantity" }, { key: "costPrice", title: "Cost Price" }, { key: "totalValue", title: "Total Value (RWF)" }]} />
          </div>
